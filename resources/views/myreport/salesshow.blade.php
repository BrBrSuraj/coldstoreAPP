            ...
            <div
                ...
                <div class="flex justify-between w-full">
                    <div class="py-3 px-6  border-gray-300 bg-gray-400 w-full">
                        <h4 class="font-bold uppercase">Customer Payment Report</h4>
                    </div>
                </div>
                    ...
                    <div class="py-5">
                        <div class="flex flex-col md:flex-row flex-start items-center gap-3">
                            <h2 class="text-xl md:ml-16 font-semibold leading-tight flex justify-start"><span
                                    class="font-bold uppercase text-green-900 underline"> {{ $customers->name }} </span>
                                ...
                                <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                                    <div class="overflow-hidden">
                                        <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                                            ...
                                            <div class="overflow-hidden">
                                                <table id="customerPaymentReportTable"
                                                    ...
                                                    <tbody>
                                                        @forelse ($customers->sale_payments as $payment)
                                                        <tr
                                               ...
                                               <div id="customerInfo" class="mt-2 mx-2 font-semibold font-sans">
                                                {{ "Payment Statement of"." ".$customers->name }}
                                               </div>
                ...
                <div id="printHeader" class="md:hidden mt-10 flex flex-col md:mx-5  items-start pt-2 rounded bg-purple-100">
                    <div
                        class="text-center border-t-2 border-t-purple-300 px-1 mx-10 text-gray-900 font-semibold text-md">
                        Subash Kattel
