    ...
    <div class="flex justify-center">
        <div class="mt-4 block rounded-lg shadow-lg bg-white w-full text-start">
            ...
            <div class="mx-auto drop-shadow rounded-md w-max-auto">
                    ...
                    <details class="bg-cool-gray-600 open:bg-amber-200 duration-300">
                        <summary class="bg-cool-gray-600 text-white px-5 py-3 text-lg cursor-pointer">Sale Payments</summary>
