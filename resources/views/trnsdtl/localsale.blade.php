<div
    ...
    <div class="flex flex-col justify-between md:w-80 p-4 leading-normal ">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900  dark:text-white">Locals Sales Details </h5>


        <dl class="max-w-md text-gray-900 divide-y divide-gray-400 dark:text-white dark:divide-gray-700">
            <div class="flex flex-col pb-3">
                <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Customer</dt>
                <dd class="text-lg font-semibold">No: {{ $locals->count() }}</dd>
            </div>
            ...
            <div class="flex flex-col pt-3">
                ...
                <dd class="text-lg font-semibold">{{ $locals->sum('weight')." "."kg." }}</dd>
            </div>
            <div class="flex flex-col pt-3">
                <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Total Cost</dt>
                <dd class="text-lg font-semibold">{{formatedNumber($locals->sum('total')) }}</dd>
            </div>
